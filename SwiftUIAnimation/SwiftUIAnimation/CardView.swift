...
let cardViews = [
            CardView(image: "mockup", category: "SwiftUI", heading: "Drawing a Border with Rounded Corners", author: "Simon", rating: 4, excerpt: "With SwiftUI, you can easily draw a border around a button or text (and it actually works for all views) using the border modifier."),

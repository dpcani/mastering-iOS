...
struct ContentView: View {
    ...
    var body: some View {
        VStack {
            ...
            FormField(fieldValue: $userRegistrationViewModel.username, fieldName: "Username")
            ...
            FormField(fieldValue: $userRegistrationViewModel.password, fieldName: "Password", isSecure: true)
            ...
            FormField(fieldValue: $userRegistrationViewModel.passwordConfirm, fieldName: "Confirm Password", isSecure: true)
...
struct FormField: View {
    ...
    var body: some View {
        VStack {
            ...
            Divider()
            .frame(height: 1)
            .background(Color(red: 240/255, green: 240/255, blue: 240/255)) .padding(.horizontal)
        }
    }
}
